...
def CanonicalRequest(r, signedHeaders):
    ...
    return "%s\n%s\n%s\n%s\n%s\n%s" % (
        r.method, CanonicalURI(r), CanonicalQueryString(r), canonicalHeaders, ";".join(signedHeaders), hexencode)
...
class Signer:
    ...
    def Verify(self, r, authorization):
        ...
        print("authorization",SignStringToSign(stringToSign, self.Secret))
